...
@Composable
fun CupcakeAppBar(
    currentSceen: CupcakeScreen,
    canNavigateBack: Boolean,
    navigateUp: () -> Unit = {},
    modifier: Modifier = Modifier
) {
    TopAppBar(title = { Text(stringResource(id = currentSceen.title)) },
...
enum class CupcakeScreen(@StringRes val title: Int) {
    Start(R.string.app_name), Flavor(R.string.choose_flavor), Pickup(R.string.choose_pickup_date), Summary(
...
fun CupcakeApp(
    ...
    Scaffold(topBar = {
        CupcakeAppBar(currentSceen = currentScreen,
